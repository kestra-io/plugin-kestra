...
public class List extends AbstractKestraTask implements RunnableTask<List.Output> {
    ...
    public Output run(RunContext runContext) throws Exception {
        ...
        if (rPage != null) {
            ...
            long total;
            do {
                PagedResultsIAMServiceAccountControllerApiServiceAccountDetail results =
                    kestraClient.serviceAccount().listServiceAccountsForTenant(rTenant, currentPage, rSize, null, null);
    ...
    public static class Output implements io.kestra.core.models.tasks.Output {
        ...
        @Schema(title = "Number of fetched service accounts. Only populated if fetchType is not NONE.")
        private Long size;
    }
}
