...
@NoArgsConstructor
@Schema(
    title = "Export flows by namespace/labels",
    description = "Exports flows matching namespace prefix and optional labels into a ZIP written to internal storage. Returns the stored URI."
)
@Plugin(
    examples = {
        @Example(
