...
public class DeleteTest extends AbstractKestraOssContainerTest {
    ...
    public void shouldProvideDeleteExecutionId() throws Exception {
        ...
        ApiLightExecution execution = queryExecution(flow.getId());
        ...
        NoSuchElementException exception = assertThrows(NoSuchElementException.class, () -> deleteTask.run(runContext));
    ...
    public void failedDeleteNoneFinalExecution() throws Exception {
        ...
        // Check the delete result
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> deleteTask.run(runContext));
